...
export default function TeacherDashboard() {
  ...
  useEffect(() => {
    const fetchTickets = async () => {
      try {
        const response = await axios.get("https://attend-ease-kappa.vercel.app/api/tickets", {
          headers: {
  ...
  const handleApprove = async (ticketId) => {
    try {
      const response = await axios.put(
        `https://attend-ease-kappa.vercel.app/api/tickets/${ticketId}/approve`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleReject = async (ticketId) => {
    try {
      const response = await axios.put(
        `https://attend-ease-kappa.vercel.app/api/tickets/${ticketId}/reject`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
