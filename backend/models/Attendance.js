...
attendanceSchema.index({ classSessionId: 1 }, { unique: true });

// 📊 STATIC METHODS for statistics
attendanceSchema.statics.getClassSessions = async function(subjectId, section) {
...
attendanceSchema.statics.updateStudentTotals = async function(studentId, subjectId) {
