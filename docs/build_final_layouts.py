...
out_syn = os.path.join(SRC, "Synopsis_BTech_AttendEase_Layout_v2.docx")
out_rpt = os.path.join(SRC, "Report_BTech_AttendEase_Layout_v2.docx")
...
def add_heading(doc, text, level, h1=16, h2=14, h3=12, body=14):
    if level == 1:
        size_pt = h1
        bold = True
        style = "Heading 1"
    ...
    p.paragraph_format.keep_with_next = True
    run = p.add_run(text)
    set_run(run, size_pt=size_pt, bold=bold)
    return p
...
def add_table(doc, rows, body_size=14):
    if not rows:
        return
...
# Title page matching reference synopsis style
add_paragraph(syn_doc, "PROJECT SYNOPSIS", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=14, bold=True, space_after=12)
add_paragraph(syn_doc, "AttendEase", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=26, bold=True, space_after=6)
...
add_paragraph(syn_doc, "Submitted in partial fulfilment of the requirements for the award of the degree of", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=True, space_after=6)
add_paragraph(syn_doc, "B.Tech in Computer Science and Engineering", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=True, space_after=24)
add_paragraph(syn_doc, "Submitted By:", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=True, space_after=6)
add_paragraph(syn_doc, "Parth Manocha (23BCON0051)", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=24)
add_paragraph(syn_doc, "Under the Supervision of", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=True, space_after=6)
add_paragraph(syn_doc, "Name of Guide:- Mr. Divyansh Dewani", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=6)
add_paragraph(syn_doc, "Designation of Guide:- Teaching Assistant", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=6)
add_paragraph(syn_doc, "(Department of Computer Science and Engineering)", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=24)
add_paragraph(syn_doc, "JECRC University, Jaipur", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=True, space_after=12)
add_paragraph(syn_doc, "2025-26", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=24)
...
def insert_toc(doc, title="Table of Contents"):
    """Insert a proper Word Table of Contents field that auto-updates on open."""
    title_para = doc.add_paragraph()
    title_para.alignment = WD_ALIGN_PARAGRAPH.CENTER
    title_para.paragraph_format.space_after = Pt(12)
    run = title_para.add_run(title)
    set_run(run, size_pt=16, bold=True)

    # TOC paragraph with field codes
...
# Content from MD - skip the duplicate title block at the start
lines = syn_md.splitlines()
i = 0

# Skip initial title/heading lines from MD since we already have a title page
while i < len(lines):
    stripped = lines[i].strip()
    if stripped.startswith("# PROJECT SYNOPSIS OF MAJOR PROJECT") or stripped.startswith("## AttendEase") or stripped.startswith("### B.Tech"):
        i += 1
        continue
...
def flush_table(doc):
    ...
    if table_lines:
        add_table(doc, parse_md_table(table_lines), body_size=14)
        table_lines = []
    in_table = False
...
while i < len(lines):
    ...
    if stripped.startswith("# "):
        flush_table(syn_doc)
        add_heading(syn_doc, stripped.lstrip("# ").strip(), 1, h1=16, h2=14, h3=12, body=14)
    elif stripped.startswith("## "):
        flush_table(syn_doc)
        add_heading(syn_doc, stripped.lstrip("# ").strip(), 2, h1=16, h2=14, h3=12, body=14)
    elif stripped.startswith("### "):
        flush_table(syn_doc)
        add_heading(syn_doc, stripped.lstrip("# ").strip(), 3, h1=16, h2=14, h3=12, body=14)
        ...
        run = p.add_run(text)
        set_run(run, size_pt=14, bold=False)
        p.paragraph_format.line_spacing_rule = WD_LINE_SPACING.ONE_POINT_FIVE
        ...
        if text.startswith("_") and text.endswith("_"):
            text = text.strip("_")
            add_paragraph(syn_doc, text, italic=True, size_pt=14, space_after=6)
        else:
            add_paragraph(syn_doc, text, size_pt=14, space_after=6)
    i += 1
...
add_paragraph(rpt_doc, "AttendEase", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=26, bold=True, space_after=6)
...
add_paragraph(rpt_doc, "Submitted in partial fulfillment of the requirements for the award of the degree of", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=6)
add_paragraph(rpt_doc, "BACHELOR OF TECHNOLOGY", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=14, bold=True, space_after=6)
add_paragraph(rpt_doc, "in", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=6)
...
add_paragraph(rpt_doc, "Submitted By:", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=True, space_after=6)
add_paragraph(rpt_doc, "Parth Manocha (23BCON0051)", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=24)
add_paragraph(rpt_doc, "Under the Supervision of", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=True, space_after=6)
add_paragraph(rpt_doc, "Mr. Divyansh Dewani", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=True, space_after=6)
add_paragraph(rpt_doc, "Teaching Assistant", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=6)
add_paragraph(rpt_doc, "Department of Computer Science and Engineering", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=24)
add_paragraph(rpt_doc, "JECRC University, Jaipur", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=True, space_after=12)
add_paragraph(rpt_doc, "2025-26", align=WD_ALIGN_PARAGRAPH.CENTER, size_pt=16, bold=False, space_after=24)
...
def flush_table(doc):
    global table_lines, in_table
    if table_lines:
        add_table(doc, parse_md_table(table_lines), body_size=16)
        table_lines = []
    in_table = False
...
while i < len(lines):
    ...
    if stripped.startswith("# "):
        flush_table(rpt_doc)
        add_heading(rpt_doc, stripped.lstrip("# ").strip(), 1, h1=16, h2=14, h3=12, body=16)
    elif stripped.startswith("## "):
        flush_table(rpt_doc)
        add_heading(rpt_doc, stripped.lstrip("# ").strip(), 2, h1=16, h2=14, h3=12, body=16)
    elif stripped.startswith("### "):
        flush_table(rpt_doc)
        add_heading(rpt_doc, stripped.lstrip("# ").strip(), 3, h1=16, h2=14, h3=12, body=16)
    elif stripped.startswith("#### "):
        flush_table(rpt_doc)
        add_heading(rpt_doc, stripped.lstrip("# ").strip(), 4, h1=16, h2=14, h3=12, body=16)
    elif stripped.startswith("- ") or re.match(r"^\d+\.\s", stripped):
        text = re.sub(r"^[- ]\s*", "", stripped)
        text = re.sub(r"\*\*(.*?)\*\*", r"\1", text)
        text = re.sub(r"\*(.*?)\*", r"\1", text)
        ...
        run = p.add_run(text)
        set_run(run, size_pt=16, bold=False)
        p.paragraph_format.line_spacing_rule = WD_LINE_SPACING.ONE_POINT_FIVE
        p.paragraph_format.space_after = Pt(3)
    elif stripped == "":
        ...
        if text.startswith("_") and text.endswith("_"):
            text = text.strip("_")
            add_paragraph(rpt_doc, text, italic=True, size_pt=16, space_after=6)
        else:
            add_paragraph(rpt_doc, text, size_pt=16, space_after=6)
    i += 1
